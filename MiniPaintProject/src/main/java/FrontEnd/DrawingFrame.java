...
import FrontEnd.SquareProperties;
...
public class DrawingFrame extends javax.swing.JFrame implements Node{
    ...
    private void squareButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_squareButtonActionPerformed
        ...
        SquareProperties squareProperties = new SquareProperties(square);
        squareProperties.setParentNode(this);
        squareProperties.setVisible(true);
        this.setVisible(false);
        drawingPanel.addShape(square);
        drawingPanel.refresh(null);
        jComboBox1.addItem("square" + drawingPanel.getShapes().length); 
